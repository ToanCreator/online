...
const subjects = [
    ...
    },
    {
        ...
        lessons: ["Bài 1", "BỘ 30 ĐỀ THI TNTHPT TIN HỌC 2025"]
    },
    {
            id: 7,
            title: "Websites",
...
function downloadLesson() {
    ...
    const fileUrls = {
        "Sinh Học": {
            "Bài 1": "https://is.gd/RSECX2",
            "Bài 2": "https://is.gd/xihR7z",
        },
        "Tin Học": {
            "Bài 1": "https://is.gd/j5iU5Z",
            "BỘ 30 ĐỀ THI TNTHPT TIN HỌC 2025": "https://is.gd/0Byez9",
        },
        "Toán Học": {
            "Bài 1": "https://is.gd/1bVwOH",
        },
        "Websites": {
            "THPT NGÔ GIA TỰ": "http://thptngogiatu.giaoductayninh.vn/"
        },
    };
    
    const fileUrl = fileUrls[currentSubject.title]?.[currentLesson];
    
    if (!fileUrl) {
        alert("Bài học đang được cập nhật, tạm thời không tải được!");
        closeModal();
        return;
    }
